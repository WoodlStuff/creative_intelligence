...
public class AiPrompt {
    ...
    private final String prompt, systemPrompt;
    ...
    private AiPrompt(Long id, String prompt, int promptType, String systemPrompt, Status status) {
        this.id = id;
        this.prompt = prompt;
    ...
    public static AiPrompt create(Long id, String prompt, int promptType) {
        return new AiPrompt(id, prompt, promptType, null, Status.ACTIVE);
    }

    public static AiPrompt create(ResultSet rs) throws SQLException {
        Long id = rs.getLong("id");
        String prompt = rs.getString("prompt");
        String systemPrompt = rs.getString("system_prompt");
        int promptType = rs.getInt("prompt_type");
        int status = rs.getInt("status");
        return new AiPrompt(id, prompt, promptType, systemPrompt, Status.parse(status));
    }
