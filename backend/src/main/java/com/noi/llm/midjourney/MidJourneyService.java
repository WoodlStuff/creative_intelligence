package com.noi.llm.midjourney;
...
public class MidJourneyService extends LLMService {
    public static final String NAME = "MidJourney";

    public MidJourneyService(AiModel model) {
        super(NAME, model);
    }
